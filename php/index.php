    ...
    <body>
        <div class="content-block" id="header">
            <div id="overlay-1">
                <header id="site-header" class="clearfix">
                    <div class="pull-left">
                        <h1><a href="#">Tharindu Siriwardhana</a></h1>
                    </div>
                ...
                <div class="middle text-center clearfix">
                    <div class="container">
                        <h1 class="pro-name">Software <!-- <span style="color: #71b644;" > -->Engineer<!-- </span> --></h1>
                        <p class="tagline">Scalable, Fast, and Secure Back-End Solutions</p>
                        <div class="skills">
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="numbersList">
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Industrial Work Experience </h4>
                        ...
                        <div class="row">
                            <div class="col-md-6 wow animated fadeInLeft">
                                <form class="contact-form" action="form.php">
                                    <input type="text" name="name" placeholder="Name" autocomplete="username" required=>
                            ...
                            <div class="col-md-6 wow animated fadeInRight">
                                    ...
                                    <div class="col-md-12">
                                        <div class="contact-info">
                                            <div class="clearfix">
                                                ...
                                                <p><strong> Address:</strong> 279/A/7, Pathaha Road,<br> Udugampola, Sri Lanka
                                                </p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                ...
                                                <p><strong> Whatsapp:</strong> +94 71 344 1069</p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                    <div class="sqaure-nebir"></div>
                                                ...
                                                <p>
                                                    <strong> Email:</strong> sudarakatharindu@outlook.com
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <ul class="social-box">
                                        <li><a target="_blank" class="facebook-icon" href="https://www.facebook.com/tharindu.siriwardana.9/"><i class="fa fa-facebook"></i></a></li>
                                        <li><a target="_blank" class="g-plus-icon" href="https://github.com/Silverviles"><i class="fa fa-github"></i></a></li>
                                        <li><a target="_blank" class="linkedin-icon" href="https://www.linkedin.com/in/tharindu-siriwardhana/"><i class="fa fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <footer id="site-footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="copyright">&copy; Silverviles</div>
                    </div>
                    <div class="col-sm-6">
                        <div class="designed-by">UI Designed By <a href="http://themewagon.com/" target="_blank">ThemeWagon</a></div>
                    </div>
                </div>
            </div>
        </footer>	<!-- site-footer -->
